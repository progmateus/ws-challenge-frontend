...
export function ModelItem({ model }: IProps) {
  return (
    <div className={styles.container}>
      ...
      <div>
        <div className={styles.descriptions}>
          <span > Nome: </span>
          <span className={styles.attribute}> {model.nome} </span>
        </div>
        <div className={styles.descriptions}>
          <span> Marca: </span>
          <span className={styles.attribute}> {model.marcaEntity?.nome} </span>
        </div>
        <div className={styles.descriptions}>
          <span> Valor flipe: </span>
          <span className={styles.attribute}> R$ {model.valor_flipe} </span>
        </div>
      </div>
    </div>
  );
